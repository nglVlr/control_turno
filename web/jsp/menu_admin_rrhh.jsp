...
<head>
    ...
    <title>Panel AdminRRHH — Control de Turnos</title>
    ...
    <style>
        ...
        .mcard:hover {
            ...
            box-shadow: 0 8px 24px rgba(44,62,80,.13);
            color: inherit;
        }
        .mcard-icon {
        ...
        .mcard-icon.teal   { background: #ccfbf1; }
...
<div class="container mt-4">
    ...
    <div class="menu-hero">
        ...
        <p>Panel de Administrador de Recursos Humanos — <%= new java.text.SimpleDateFormat("EEEE d 'de' MMMM, yyyy", new java.util.Locale("es")).format(new java.util.Date()) %></p>
    </div>

    <div class="row g-3">

        <div class="col-lg-4 col-md-6">
            <a href="${pageContext.request.contextPath}/EmpleadoServlet?accion=listar" class="mcard">
                <div class="mcard-icon blue">👥</div>
                <div>
                    <h6>Mantenimiento de Usuarios</h6>
                    <p>Agregar, consultar, roles, áreas y gestión completa de empleados</p>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <a href="${pageContext.request.contextPath}/AsignacionTurnoServlet?accion=listar" class="mcard">
                ...
                <div>
                    ...
                    <p>Ver y gestionar todas las asignaciones del sistema</p>
                </div>
            </a>
        </div>

        <div class="col-lg-4 col-md-6">
            <a href="${pageContext.request.contextPath}/ReasignacionServlet?accion=listar" class="mcard">
                <div class="mcard-icon orange">🔄</div>
                <div>
                    <h6>Reasignación de Empleados</h6>
                    <p>Cambiar área, turno y AdminArea directamente</p>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <a href="${pageContext.request.contextPath}/SolicitudServlet?accion=menu" class="mcard">
                ...
                <div>
                    <h6>Solicitudes</h6>
                    <p>Aprobar o rechazar cambios de turno y licencias</p>
                </div>
            </a>
        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <a href="${pageContext.request.contextPath}/MarcajeServlet" class="mcard">
                <div class="mcard-icon teal">🕐</div>
                <div>
                    <h6>Marcaje General</h6>
                    <p>Ver el marcaje de todos los empleados en tiempo real</p>
                </div>
            </a>
        </div>
