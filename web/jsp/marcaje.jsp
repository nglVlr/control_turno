...
<%
    ...
    String menuRegresar = sesion.getNombreRol().equals("AdminArea")
...
<head>
    ...
    <title>Marcaje — Control de Turnos</title>
...
<div class="container mt-4">
    ...
    <!-- Alerta error — FA05, FA06, FA08, FA09 con mensajes exactos del CU -->
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-7">
            <div class="card shadow-sm border-0 p-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <div class="text-muted small mt-1" id="fecha-hoy"></div>
                </div>
                ...
                <% } else { %>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-3">
                        ...
                        <form action="${pageContext.request.contextPath}/MarcajeServlet" method="post">
                            ...
                            <button type="submit" class="btn btn-warning btn-marcaje"
                                <%= !puedeDescanso1 ? "disabled" : "" %>>
                                ☕ Marcar Descanso 1
                            </button>
                        </form>
                        ...
                        <form action="${pageContext.request.contextPath}/MarcajeServlet" method="post">
                            ...
                            <button type="submit" class="btn btn-danger btn-marcaje"
        ...
        <!-- Panel derecho: Información del Marcaje — CU2 paso 4f -->
        <div class="col-lg-5">
            <div class="card shadow-sm border-0 p-4">
                ...
                <div class="step-item">
                    <div class="step-circle <%=
                        (m != null && m.getHoraEntrada() != null) ? "step-done" :
                        puedeEntrada ? "step-active" : "step-pending" %>">1</div>
                    <div>
                        <div class="small fw-semibold">Entrada
                            <% if (m != null && m.getEntradaTarde() == 1) { %>
                                <span class="badge badge-pendiente ms-1 px-2 py-1 rounded">Tarde</span>
                            <% } %>
                        </div>
                        <% if (m != null && m.getHoraEntrada() != null) { %>
                            <div class="hora-display"><%= m.getHoraEntrada() %></div>
                        <% } else { %>
                            <div class="hora-vacia">Sin registrar</div>
                        <% } %>
                    </div>
                </div>
                ...
                <div class="step-item">
                    <div class="step-circle <%=
                        (m != null && m.getHoraDescanso1() != null) ? "step-done" :
                        puedeDescanso1 ? "step-active" : "step-pending" %>">2</div>
                    <div>
                        <div class="small fw-semibold">Descanso 1</div>
                        <% if (m != null && m.getHoraDescanso1() != null) { %>
                            <div class="hora-display"><%= m.getHoraDescanso1() %></div>
                        <% } else { %>
                            <div class="hora-vacia">Sin registrar</div>
                        <% } %>
                    </div>
                ...
                <div class="step-item">
                    <div class="step-circle <%=
                        (m != null && m.getHoraDescanso2() != null) ? "step-done" :
                        puedeDescanso2 ? "step-active" : "step-pending" %>">3</div>
                    <div>
                        <div class="small fw-semibold">Descanso 2</div>
                        <% if (m != null && m.getHoraDescanso2() != null) { %>
                            <div class="hora-display"><%= m.getHoraDescanso2() %></div>
                        <% } else { %>
                            <div class="hora-vacia">Sin registrar</div>
                        <% } %>
                    </div>
                ...
                <div class="step-item">
                    <div class="step-circle <%=
                        (m != null && m.getHoraSalida() != null) ? "step-done" :
                        puedeSalida ? "step-active" : "step-pending" %>">4</div>
                    <div>
                        <div class="small fw-semibold">Salida</div>
                        <% if (m != null && m.getHoraSalida() != null) { %>
                            <div class="hora-display"><%= m.getHoraSalida() %></div>
                        <% } else { %>
                            <div class="hora-vacia">Sin registrar</div>
                        <% } %>
                    </div>
...
<script>
    // Timer en tiempo real — CU2 paso 4a
