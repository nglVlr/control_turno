...
<div class="container mt-4">
    ...
    <%-- Mostrar horario del turno del empleado --%>
    <% if (request.getAttribute("turno") != null) {
        controlTurnos.modelo.Turno turnoEmp = (controlTurnos.modelo.Turno) request.getAttribute("turno"); %>
        <div class="alert alert-secondary py-2 mb-3">
            <small>🕐 Tu turno: <strong><%= turnoEmp.getNombreTurno() %></strong>
            &nbsp;|&nbsp; <%= turnoEmp.getHoraInicio() %> — <%= turnoEmp.getHoraFin() %>
            &nbsp;|&nbsp; Puedes marcar entrada desde las
            <strong><%= turnoEmp.getHoraInicio().substring(0,5) %></strong>
            (hasta 15 min antes también es válido)
            </small>
        </div>
    <% } %>
...
<script>
    ...
    // Polling cada 15 segundos — recarga la página para actualizar
    // tabla de marcajes del área en tiempo real (CU2 requerimiento)
