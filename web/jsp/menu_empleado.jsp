...
<div class="container mt-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <a href="${pageContext.request.contextPath}/EmpleadoGestionServlet?accion=formularioGestion" class="card menu-card shadow-sm h-100 d-block p-3">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <a href="${pageContext.request.contextPath}/EmpleadoGestionServlet?accion=formularioCambioTurno" class="card menu-card shadow-sm h-100 d-block p-3">
                <div class="card-body">
                    <h6 class="fw-bold mb-2">Cambio de Turno</h6>
                    <p class="text-muted small mb-0">Solicitar un cambio de turno o área</p>
                </div>
            </a>
        </div>
